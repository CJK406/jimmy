        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Raffle List</h4>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Create Raffle</h5>
      ...
      <div class="modal-body">
      	<div class="form-group">
      		<label for="c_raffle_name">Name:</label>
...
<div class="modal" id="edit_modal" tabindex="2"  >
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Edit Raffle</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
      	<div class="form-group">
      		<label for="e_raffle_name">Name:</label>
...
<script type="text/javascript">
    ...
    $('body').on('click', '.edit_btn', function () {
    	...
    	$("#e_name").val(raffles[index]['raffle_name']);
    	$("#e_desc").val(raffles[index]['description']);
    	$("#e_delivery").val(raffles[index]['delivery']);
    	$("#e_terms").val(raffles[index]['terms']);
    	$("#e_price").val(raffles[index]['price']);

		var dateVal = new Date(raffles[index]['end_time']);
