            ...
            <div class="col-sm-12">
                <div class="page-title-box">
                  <div class="float-right">
                    ...
                    <h4 class="page-title">Raffle Images</h4>
          ...
          var formdata = new FormData();
           ...
           var filename = blob.name;
            ...
            $("#uploadimageModal").modal('hide');
              jQuery.ajax({
                  url:"<?php echo $site_url?>api/upload/raffle/upload.php",
                  data: formdata,
                  processData: false,
                  contentType: false,
                  type: 'post',
  ...
  function show_images(){
    ...
    for(var i=0; i<images.length; i++){
      string +=`<div class="col-md-3" id="image_div_`+i+`" style="text-align: center; margin-bottom:20px">
                    <img src="../../api/upload/raffle/`+id+`/`+images[i]+`" style="width: 100%; border-radius: 10px; min-height:220px">
